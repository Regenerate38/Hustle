    ...
    <View style={styles.PostDetailPage}>
      {jobDetail && (
        <View>
          <View
            id={"imagecontainer"}
            style={styles.PostDetailPage_image_container}
          >
            <Image
              source={
          ...
          <View style={styles.PostDetailPage_curved_container}></View>
          ...
          >
            <Text style={styles.PostDetailPage_title_text}>
            ...
            >
              ...
              >
                ...
                <Text style={styles.PostDetailPage_date_value}>
                  {jobDetail.date || "Default Date"}
                </Text>
              </View>
              ...
              >
                <Text style={styles.PostDetailPage_number_label}>
                  Number of Volunteers
                </Text>

                <Text style={styles.PostDetailPage_number_value}>
                  {jobDetail.volunteerNo || 1}
                </Text>
              </View>
            </View>

            <Text style={styles.PostDetailPage_description_label}>
              {"Description:"}
            </Text>
            ...
            >
              <TouchableOpacity style={styles.PostDetailPage_confirm_button}>
                <Text style={styles.PostDetailPage_confirm_button_text}>
